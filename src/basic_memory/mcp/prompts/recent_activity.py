...
async def recent_activity_prompt(
    ...
    # Pass type="entity" to match the original prompt scope (entities only,
    # not observations or relations) while using the upstream callable form.
    activity_summary = await recent_activity(
